...
function funParseReal(method, path, item, defObject) {
  ...
  } = (0, _jsdocParse.default)(funDesc, parameters, responses, defObject); // 转换params
...
function swagger2Parse(data) {
  ...
  let interfaceList = []; // 解析typedef

  const defObject = (0, _definitions.default)(definitions);
