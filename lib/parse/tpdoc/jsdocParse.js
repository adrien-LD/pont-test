...
function jsdocParse(funDesc, parameters, responses, defObject) {
  ...
  parameters.forEach(item => {
    ...
    const typeResult = (0, _definitions.translateType)(entityName);
  ...
  const returnTypeResult = (0, _definitions.translateType)(responses.entityName);
